...
- [x] v2.7 (2026-09-25, сводка экономии): /graft stats — агрегация по всем файлам
      ...
      7 дней» в обычный /graft; невалидные файлы метрик пропускаются; smoke 58
- [x] v2.8 (2026-09-25, паритет с референсом, детерминированные):
...
- [x] v2.9 (2026-09-25, lean-injection паритет): push-пакет — топ-3 **только
